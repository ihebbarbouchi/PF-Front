        ...
        <Layout role="teacher" onSearch={handleSearch}>
            <div className="space-y-6">
                <div className="flex items-center justify-between">
                    ...
                    <Button onClick={() => router.push('/add-resource')} className="bg-blue-600 hover:bg-blue-700">
                ...
                {filteredResources.length === 0 && (
                    <div className="text-center py-12">
                        ...
                        <Button onClick={() => router.push('/add-resource')} className="mt-4 bg-blue-600 hover:bg-blue-700">
                            <PlusCircle className="w-4 h-4 mr-2" />
